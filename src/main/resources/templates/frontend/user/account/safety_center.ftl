...
<div class="row">
    <div class="col-lg-12">
                    ...
                    <div class="col-lg-12">
                        ...
                        <form id="user_account_form" action="/user/account/info/update"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-6">
                                    <a href="/user/account/password/modify"
        ...
        <div class="panel panel-success">
            ...
            <#else >
                <div id="errorPrompt" class="alert alert-danger alert-dismissable">
                    <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                    您还没有设置密码保护问题，为了您的账户安全，请马上设置
                </div>
            </#if>
                <form id="password_protection_form" action="/user/account/safety"
                      class="form-horizontal" role="form" method="POST">
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <select id="password_questions" name="question" class="form-control">
                                <option value="">------ 请选择密码保护提示问题 ------</option>
                    ...
                    <div class="form-group">
                        <div class="col-lg-offset-3 col-lg-8">
                            <button type="submit" class="btn btn-success"><#if user.passwordSafety??>
                                更新密保及答案<#else>设置密保问题及答案</#if></button>
                        </div>
                    </div>
                </form>
            </div>
