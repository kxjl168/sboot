   ...
   <div id="header">
					...
					<dd class="fl login">
						<script type="application/javascript">
							$(document).ready(function(){
								$.ajax({
									type: 'POST',
									url: "/front/isLogin.action?dt=" + (new Date()).valueOf(),
									dataType: "json",
									success: function (data) {
										if(data.code==1){
											$("#loginInfo").html("&nbsp;"+data.userName+",你好! &nbsp; <a class=\"\"  href=\"/front/logout.action\">退出</a>")
										}else{
											$("#loginInfo").html("<a class=\"dlu\"  href=\"/front/loginPage.html\">请登录</a>\n" +
													"\t\t\t\t\t\t<a href=\"/front/registPage.html\">免费注册</a>")
										}
									}
								});
								//alert(222);
    ...
    <div id="">
      ...
      <div class='miaov_head' style="margin-top: 30px;">
		   ...
		   <iframe MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no src="/decorators/public/footer.ftl" width="100%"  height="502px">
		  </iframe> 
		</div>
		<div class='miaov_head' style="position: fixed;right: 0;top:0;">
		   <iframe MARGINWIDTH=0 MARGINHEIGHT=0 HSPACE=0 VSPACE=0 FRAMEBORDER=0 SCROLLING=no src="/decorators/public/side-banner.ftl" width="100%"  height="1374px">
		  </iframe>
		</div> 
