...
<body>
							...
							<div class="row ">
								<div class=" col-sm-9">
									...
									<div class="input-group">
										<span for="name" class="input-group-addon">商品名称:</span>
							...
							<div class="tab-content">
								...
								<div class="row tab-pane " id="identifier5">
									...
									<div class=" col-lg-12 margin-top-5">
										...
										<div class="row">
										<form id="mform_detail"  class="form-horizontal"
											role="form" action="" method="post">
											<div class="form-group">
												...
												<div class="col-lg-10">
													...
													<div id="detail_error" class="has-error ">
	...
	<script src="/vendor/goods/js/FileUploadMuti.js"></script>
