...
<body>
	...
	<div>
							...
							<div class="row ">
								<div class=" col-sm-9">
									<div class="form-group">
										<label for="name" class="lb_text col-lg-5 control-label">名称:</label>
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">
							表数据编辑 <span id="message" style="margin-left: 20px;"></span>
						</h4>
		...
		<script src="/vendor/normal/js/normal.js"></script>
</body>
</html>