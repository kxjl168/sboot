...
import com.ztgm.mall.service.impl.CustomerServiceImpl;
import com.ztgm.mall.service.impl.ManagerServiceImpl;
//import com.ztgm.mall.service.impl.UserServiceImpl;
...
//        rtp.opsForValue().set("u_zhang",u);
    ...
    */
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object o) throws Exception {
        ApplicationContext ctx = WebApplicationContextUtils.getRequiredWebApplicationContext( request.getServletContext());
        CustomerServiceImpl userService=(CustomerServiceImpl)ctx.getBean("customerServiceImpl");
     //   GroupUserServiceImpl groupUserService=(GroupUserServiceImpl)ctx.getBean("groupUserServiceImpl");
        ...
        MUser user=userService.getUserByToken(token);
        if(user==null){
