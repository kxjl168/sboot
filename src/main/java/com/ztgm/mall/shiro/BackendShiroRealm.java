 ...
 * @create 2016年1月13日
 */
public class BackendShiroRealm extends AuthorizingRealm {

    private static final Logger logger = LoggerFactory.getLogger(BackendShiroRealm.class);
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken)
        ...
        List<Manager> users = userService.selectManagerByManager(user);
        // 未找到用户信息
        ...
        // 密文方式验证密码
        authenticationInfo = new SimpleAuthenticationInfo(principal, user.getPassword(),
                ByteSource.Util.bytes(user.getTelephone()), getName());
