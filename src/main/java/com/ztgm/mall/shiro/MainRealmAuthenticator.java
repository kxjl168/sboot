...
public class MainRealmAuthenticator extends org.apache.shiro.authc.pam.ModularRealmAuthenticator {
    ...
    protected AuthenticationInfo doAuthenticate(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        realm = (Realm) this.definedRealms.get(token.getUserType() + "ShiroRealm");
